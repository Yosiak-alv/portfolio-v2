    ...
    return(
        <div data-aos="fade-right" className='px-5 max-w-[1560px] mx-auto min-h-screen pt-20 flex items-center justify-between flex-wrap'>
            <div className='w-10/12 sm:w-8/12 mx-auto '>
                ...
                <a href="https://yosiak-alv.github.io/resume/" target='_blank' rel='noopener noreferrer' className="text-white font-medium py-2 px-4 border duration-200 border-customBlue hover:bg-customBlue-700">
                    View Résumé
                </a>
            </div>
